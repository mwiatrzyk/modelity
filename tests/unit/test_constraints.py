...
class TestMinValue:
    ...
    @pytest.mark.parametrize("min_inclusive, min_exclusive, expected_error", [
    ...
    def test_init_fails_if_called_with_invalid_combination_of_params(self, min_inclusive, min_exclusive, expected_error):
...
class TestMaxValue:
    ...
    @pytest.mark.parametrize("max_inclusive, max_exclusive, expected_error", [
    ...
    def test_init_fails_if_called_with_invalid_combination_of_params(self, max_inclusive, max_exclusive, expected_error):
        with pytest.raises(TypeError) as excinfo:
